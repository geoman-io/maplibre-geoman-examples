...
export const metadata: Metadata = {
  title: "Geoman Pro — GIS Editor Demo",
  description:
    "A fully custom GIS editor built on MapLibre Geoman Pro: custom controls, layers, per-feature metadata, GitHub auth, and Postgres persistence.",
};
